...
std::shared_ptr<mermaid::components::Button> mermaid::components::Button::create(const std::string& text,
                                                                                 mermaid::Font& font)
{
...
void mermaid::components::Button::setText(const std::string& text)
{
    this->text->setText(text);
}

std::string mermaid::components::Button::getText()
{
